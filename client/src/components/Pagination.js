...
const Pagination = (props) => {
  ...
  //Saving the query variables from the search so that the pagination can work
  ...
  <nav className="page-navigation">
      <button onClick={previousPage} disabled={currentPage === 1} className="page-link prev_next-btn" aria-label="Previous">
      ...
      <button onClick={nextPage} disabled={currentPage === pageCount} className="page-link prev_next-btn" aria-label="Next">
