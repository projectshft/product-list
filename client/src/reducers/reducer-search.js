...
export default function(state = { page: 1, category:'', price:'', name: '' }, action) {
  switch (action.type) {
    case CATEGORY_SEARCH:
        return Object.assign({}, state, { page: action.page, category: action.category })
    case PRICE_SEARCH:
        return Object.assign({}, state, { page: action.page, price: action.price })
    case PRODUCT_SEARCH:
        return Object.assign({}, state, { page: action.page, name: action.name})
    case SET_PAGE:
