...
export default function SearchBar({ setShowAllProducts }) {
      ...
      <div className='input-group'>
        ...
        <div className='dropdown'>
          ...
          <ul className='dropdown-menu' aria-labelledby='category'>
            ...
            <li>
              <a className='dropdown-item' href='#' onClick={categoryReset}>
                reset
              </a>
            </li>
          </ul>
        ...
        <div className='dropdown'>
          ...
          <ul className='dropdown-menu' aria-labelledby='sort'>
            ...
            <li>
              <a className='dropdown-item' href='#' onClick={priceReset}>
                reset
              </a>
            </li>
          </ul>
        </div>
        <button className='button btn btn-primary' onClick={handleSearch}>
          Search
        </button>
      </div>
    </div>
