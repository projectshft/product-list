...
class SearchBar extends Component {
  componentDidMount() {
    ...
    this.props.fetchProduct(category, price);
}
    constructor(props) {
        super(props);
        this.state = { term: "" };
      ...
      onCategoryFilter() {
        const { category } = fetchProduct({ category });
      }
        ...
        <div>
            ...
            <span id="search">
              <form onSubmit={this.onFormSubmit} className="input-group">
                <input placeholder="Search Product Here" className="form-control"
            ...
            <span id="filter">
                <div className="dropdown">
                  ...
                  <div className="sort-content">
                    <a onClick={this.onPriceSort.bind(this)}>Price: Low to High</a>
                    <a>Price: High to Low</a>
                  </div>
                </div>
                <div className="dropdown">
                    <button className="dropbtn btn-secondary"><font size="2"> Categories</font></button>
