...
//step 1 delete all fake data from products
//step 2 check if ref is done correctly 
//step 3 build out all the routes, colon means they want id
...
//intro and body parser parsity vid with post/ postman
